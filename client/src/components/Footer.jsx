    ...
    <footer className="bg-bg-secondary pt-20 pb-10 px-8">
      <div className="max-w-7xl mx-auto grid grid-cols-12 gap-8">
        <div className="col-span-12 md:col-span-5">
          ...
          <p className="text-text-muted text-sm leading-relaxed mb-6 max-w-sm">
            Discover curated layouts across prime locations. Every plot, personally verified by PNB DEVELOPER. We help you find your perfect investment in premium real estate.
          </p>
          <div className="space-y-3">
            ...
            <p className="text-sm text-text-muted flex gap-2 items-center">
              ...
              <a href="mailto:info@pnbdeveloper.com" className="hover:text-accent-rose transition-colors">info@pnbdeveloper.com</a>
            </p>
            <p className="text-sm text-text-muted flex gap-2">
        ...
        <div className="col-span-4 md:col-span-2">
          ...
          <ul className="space-y-3">
            ...
            <li><a href="mailto:info@pnbdeveloper.com" className="text-sm text-text-muted hover:text-accent-rose transition-colors">Email</a></li>
          </ul>
        </div>
      ...
      <div className="max-w-7xl mx-auto mt-16 pt-6 border-t border-[rgba(38,38,38,0.08)] flex flex-col md:flex-row justify-between items-center">
        <p className="text-[9px] tracking-[0.1em] text-[rgba(38,38,38,0.3)]">
          © 2025 PNB DEVELOPER. All Rights Reserved.
        </p>
        <p className="text-[9px] tracking-[0.1em] text-[rgba(38,38,38,0.3)]">
